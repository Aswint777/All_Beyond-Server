  ...
  async getChatMessagesRepository(
    ...
    try {
      ...
      if (messagesToUpdate.length > 0) {
        ...
        this.dependencies.socketService.emitToRoom(chatId, "unreadCountUpdate", {
          userId,
          chatGroupId: chatId,
          unreadCount,
        });
...
// __________________________________________________________________________________________________
    ...
    for (const participantId of participants) {
      ...
      const unreadCount = await MessageModel.countDocuments({
        ...
        this.dependencies.socketService.emitToRoom(chatMessage.chatGroupId, "unreadCountUpdate", {
      ...
      this.dependencies.socketService.emitToRoom(chatMessage.chatGroupId, "message", message);
